            ...
            <div class="p-3">
                <ul class="sidebar-menu">
                    <li style='color:#fff; border-bottom:2px solid #00c0ef'>
                        <p>SELAMAT DATANG,<p>
                        <p style="font-size:14px">{{Auth::user()->nama}} (Dosen)</p>
                    </li>

                    <li class="active">
                        <a href="dashboarddosen"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="listpengajuankkn"><i class="fa fa-file"></i> Pengajuan KKN</a>
                    </li>
                    <li>
                        <a href="pengantardosen"><i class="fa fa-file-text"></i> Pengantar Dosen</a>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu">
                            <li>
                                <a href="laporanList"><i class="fa fa-circle-o"></i> List</a>
                            </li>
                        </ul>
                    </li>
                    <li>
